...
browseURL("https://marginaleffects.com/articles/slopes.html")
...
# The slopes() function thus produces distinct estimates of the marginal effect for each row of the data used to fit the model.
mfx <- slopes(p1)
head(mfx)
...
maBina(w = p1x, x.mean = FALSE, rev.dum = TRUE) # AME, POE4, p. 594, calculated as the mean of a each data point
